...
namespace Memorizer.Server.Data.Migrations
{
    ...
    [Migration("20201105210131_Tags_MtoM")]
    partial class Tags_MtoM
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Memorizer.Server.Models.StudyingEntityTextTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("StudyingEntityTextTags");
                });
            ...
            modelBuilder.Entity("Memorizer.Server.Models.StudyingEntityWordTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("StudyingEntityWordTags");
                });
            ...
            modelBuilder.Entity("Memorizer.Server.Models.StudyingEntityText", b =>
                {
                    b.HasOne("Memorizer.Server.Models.ApplicationUser", "ApplicationUser")
                    ...
                    b.HasOne("Memorizer.Server.Models.Tag", null)
                        .WithMany("StudyingEntityTexts")
            ...
            modelBuilder.Entity("Memorizer.Server.Models.StudyingEntityTextTag", b =>
                {
                    b.HasOne("Memorizer.Server.Models.StudyingEntityText", "StudyingEntityText")
                        .WithMany("StudyingEntityTextTags")
                        .HasForeignKey("StudyingEntityTextId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Memorizer.Server.Models.Tag", "Tag")
                        .WithMany("StudyingEntityTextTags")
                        .HasForeignKey("TagId");
                });
            ...
            modelBuilder.Entity("Memorizer.Server.Models.StudyingEntityWordTag", b =>
                {
                    b.HasOne("Memorizer.Server.Models.StudyingEntityWord", "StudyingEntityWord")
                        .WithMany("StudyingEntityWordTags")
